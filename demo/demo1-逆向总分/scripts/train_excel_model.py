...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Excel-only proxy model for Demo1.")
    ...
    model_path = output_dir / "excel_model.pkl"

    print("Starting Excel Model Training Pipeline...")
    ...
    # 6. 输出特征列表与全量 SHAP 报告
    shap_output_dir = output_dir / "shap_excel"
